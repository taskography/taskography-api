...
class TaskSamplerV5(TaskSamplerBase):
    ...
    def __init__(self, domain, scenegraph, task_length=1, bagslots=3):
        """PDDL problem sampler for the Lifted Courier (n, k) task. Corresponding domain specification: domains/taskographyv5.pddl.
        """
        super(TaskSamplerV5, self).__init__(scenegraph)

        # PDDLGym domain
        assert(os.path.basename(domain) == "taskographyv5.pddl")
    ...
    def generate_pddl_entities(self):
        """Generate a dictionary of PDDL entities as per the domains/taskographyv5.pddl domain. The dictionary maps 
